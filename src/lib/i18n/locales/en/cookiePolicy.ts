import type { CookiePolicyContent } from "../../cookiePolicy.types";
...
export const cookiePolicy: CookiePolicyContent = {
  "title": "Cookie Policy",
  "lastUpdated": "June 23, 2026",
  "intro": [
    {
      "type": "p",
      "text": "This Cookie Policy explains how Ricardo Jorge Pinto da Silva Rato, empresário em nome individual (\"Company,\" \"we,\" \"us,\" and \"our\") uses cookies and similar technologies to recognize you when you visit our website at https://www.eatease.eu (\"Website\"). It explains what these technologies are and why we use them, as well as your rights to control our use of them."
    },
    {
      "type": "p",
  ...
  "sections": [
    {
      ...
      "blocks": [
        ...
        {
          "type": "p",
          "text": "Cookies set by the website owner (in this case, Ricardo Jorge Pinto da Silva Rato, empresário em nome individual) are called \"first-party cookies.\" Cookies set by parties other than the website owner are called \"third-party cookies.\" Third-party cookies enable third-party features or functionality to be provided on or through the website (e.g., advertising, interactive content, and analytics). The parties that set these third-party cookies can recognize your computer both when it visits the website in question and also when it visits certain other websites."
        }
      ]
    },
    {
    ...
    },
    {
      ...
      "blocks": [
        {
          "type": "p",
          "text": "As the means by which you can refuse cookies through your web browser controls vary from browser to browser, you should visit your browser's help menu for more information. The following is information about how to manage cookies on the most popular browsers:"
        },
        {
          "type": "linkList",
          "items": [
        ...
        {
          "type": "p",
          "text": "In addition, most advertising networks offer you a way to opt out of targeted advertising. If you would like to find out more information, please visit:"
        },
        {
          "type": "linkList",
          "items": [
            {
              "label": "Digital Advertising Alliance",
