import type { PrivacyPolicyContent } from "../../privacyPolicy.types";
...
export const privacyPolicy: PrivacyPolicyContent = {
  ...
  "intro": [
    {
      "type": "p",
      "text": "This Privacy Notice for Ricardo Jorge Pinto da Silva Rato, empresário em nome individual ('we', 'us', or 'our'), describes how and why we might access, collect, store, use, and/or share ('process') your personal information when you use our services ('Services'), including when you:"
    },
    {
      "type": "list",
      "items": [
  ...
  "summary": [
    ...
    {
      "type": "p",
      "text": "In what situations and with which types of parties do we share personal information? We may share information in specific situations and with specific categories of third parties. Learn more about when and with whom we share your personal information."
    },
    {
      "type": "p",
  ...
  "sections": [
    ...
    },
    {
      ...
      "blocks": [
        {
          "type": "inShort",
          "text": "In Short: Depending on your state of residence in the US or in some regions, such as the European Economic Area (EEA), United Kingdom (UK), and Switzerland, you have rights that allow you greater access to and control over your personal information. You may review, change, or terminate your account at any time, depending on your country, province, or state of residence."
        },
        {
          "type": "p",
        ...
        {
          "type": "p",
          "text": "If you have questions or comments about your privacy rights, you may email us at privacy@eatease.eu."
        }
      ]
    },
    {
      ...
      "blocks": [
        ...
        {
          "type": "p",
          "text": "California law requires us to let you know how we respond to web browser DNT signals. Because there currently is not an industry or legal standard for recognising or honouring DNT signals, we do not respond to them at this time."
        },
        {
          "type": "p",
    ...
    },
    {
      ...
      "blocks": [
        ...
        },
        {
          ...
          "rows": [
            ...
            [
              ...
              "Biometric data and account login information",
              "YES"
            ]
          ]
        },
        ...
        {
          "type": "p",
          "text": "We collect and share your personal information through:"
        },
        {
          "type": "list",
          "items": [
        ...
        {
          "type": "p",
          "text": "The categories of third parties to whom we disclosed personal information for a business or commercial purpose can be found under 'WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?'"
        },
        {
          "type": "subheading",
          "text": "Your Rights"
        ...
        {
          "type": "p",
          "text": "To exercise these rights, you can contact us by submitting a data subject access request, by emailing us at privacy@eatease.eu, by visiting https://www.eatease.eu, or by referring to the contact details at the bottom of this document."
        },
        {
          "type": "p",
          "text": "We will honour your opt-out preferences if you enact the Global Privacy Control (GPC) opt-out signal on your browser."
        },
        {
          "type": "p",
          "text": "Under certain US state data protection laws, you can designate an authorised agent to make a request on your behalf. We may deny a request from an authorised agent that does not submit proof that they have been validly authorised to act on your behalf in accordance with applicable laws."
        },
        {
          "type": "subheading",
        ...
        {
          "type": "p",
          "text": "If you submit the request through an authorised agent, we may need to collect additional information to verify your identity before processing your request and the agent will need to provide a written and signed permission from you to submit such request on your behalf."
        },
        {
          "type": "subheading",
          "text": "Appeals"
        ...
        {
          "type": "p",
          "text": "Under certain US state data protection laws, if we decline to take action regarding your request, you may appeal our decision by emailing us at privacy@eatease.eu. We will inform you in writing of any action taken or not taken in response to the appeal, including a written explanation of the reasons for the decisions. If your appeal is denied, you may submit a complaint to your state attorney general."
        },
        {
          "type": "subheading",
    ...
    },
    {
      ...
      "blocks": [
        {
          "type": "p",
          "text": "If you have questions or comments about this notice, you may contact our Data Protection Officer (DPO) by email at ricardo.rato@eatease.eu, by phone at +351 964657580, or contact us by post at:"
        },
        {
          "type": "p",
