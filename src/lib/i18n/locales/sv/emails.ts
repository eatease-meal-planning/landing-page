export const emails = {
  ...
  welcome: {
    ...
    greeting: "Hej {name},",
    body:     "Tack för din registrering! Vi håller på att finslipa de sista detaljerna inför lanseringen av vår app, så du kommer att bli en av de första som får använda vår tjänst.",
